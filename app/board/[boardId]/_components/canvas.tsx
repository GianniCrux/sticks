...
export const Canvas = ({
    ...
    const startDrawing = useMutation((
        ...
        setMyPresence({
            pencilDraft: [[point.x, point.y, pressure]], //not working rn cause we have to add it to the liveblocks.config in the root folder and add it to type presence as we did with the other funcionalities
